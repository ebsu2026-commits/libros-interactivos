# -*- coding: utf-8 -*-
"""
Builds the interactive HTML version of the Francés 3° de Secundaria Libro Abierto.
...
SRC_PDF = os.path.join(r"C:\Trabajo - Salome Ureña\LIBROS\FRANCES", "Lenguas Extranjeras - Francés 3° Secundaria (Libro Abierto).pdf")
