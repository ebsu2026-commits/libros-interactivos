# -*- coding: utf-8 -*-
"""
Builds the interactive HTML version of the Inglés 6° de Primaria Libro Abierto.
...
SRC_PDF = os.path.join(r"C:\Trabajo - Salome Ureña\LIBROS\INGLES", "Lenguas Extranjeras - Inglés 6° Primaria (Libro Abierto).pdf")
