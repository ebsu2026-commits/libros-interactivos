# -*- coding: utf-8 -*-
"""
Builds the interactive HTML version of the Inglés 2° de Secundaria Libro Abierto.
...
SRC_PDF = os.path.join(r"C:\Trabajo - Salome Ureña\LIBROS\INGLES", "Lenguas Extranjeras - Inglés 2° Secundaria (Libro Abierto).pdf")
